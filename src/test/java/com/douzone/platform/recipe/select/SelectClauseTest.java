...
public class SelectClauseTest {
    ...
    void testSimpleSelect() throws Exception {
        ...
        String expected = "df_selected = df.select(F.col(\"name\"), F.col(\"age\"))\n";
    ...
    void testSelectWithAlias() throws Exception {
        ...
        String expected = "df_selected = df.select(F.col(\"user_id\").alias(\"id\"), F.col(\"first_name\"))\n";
        String actual = PySparkChainGenerator.generate(json);
    ...
    void testSelectWithAsKey() throws Exception {
        ...
        String expected = "df_selected = df.select(F.col(\"user_id\").alias(\"id\"), F.col(\"age\"))\n";
        String actual = PySparkChainGenerator.generate(json);
    ...
    void testSelectWithFunctionAndAlias() throws Exception {
        ...
        String expected = "df_selected = df.select(F.col(\"id\"), F.upper(F.col(\"name\")).alias(\"upper_name\"))\n";
        String actual = PySparkChainGenerator.generate(json);
    ...
    void testSelectWithArithmeticOperation() throws Exception {
        ...
        String expected = "df_selected = df.select(F.col(\"product_name\"), (F.col(\"price\") * F.lit(1.1)).alias(\"price_with_tax\"))\n";
        String actual = PySparkChainGenerator.generate(json);
    ...
    void testSelectWithCaseWhen() throws Exception {
        ...
        String expected = "df_selected = df.select(F.col(\"id\"), (F.when((F.col(\"age\") >= F.lit(20)), F.lit(\"Adult\"))).otherwise(F.lit(\"Minor\")).alias(\"age_group\"))\n";
        String actual = PySparkChainGenerator.generate(json);
